    ...
    return (
        <>
            <section className="about">
                ...
                <p data-aos="fade-left">As a frontend web developer specializing in JavaScript I offer affordable solutions for anyone seeking to enhance their online presence. Whether you're starting small or looking to revamp your digital footprint, I'm here to help.</p>
